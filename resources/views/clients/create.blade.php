                    ...
                    <div class="card p-5 mt-5">
                        <div class="row">
                            <div class="mb-3">
                                ...
                                <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" id="name" placeholder="John ordy" value="{{ old('name') }}">
                                @error('name')
                        ...
                        <div class="row">
                            <div class="mb-3 col-8">
                                ...
                                <input type="text" name="phone" class="form-control @error('phone') is-invalid @enderror"" id="phone" placeholder="+243 ........." value="{{ old('phone') }}">
                                @error('phone')
                                    <div class="invalid-feedback">
                                        {{ $errors->first('phone') }}
                                    </div>
